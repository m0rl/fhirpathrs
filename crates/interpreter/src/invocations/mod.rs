...
pub(crate) fn interpret_function(
    ...
    match name {
        ...
        "year" | "yearOf" => utility::year(base, context),
        "month" | "monthOf" => utility::month(base, context),
        "day" | "dayOf" => utility::day(base, context),
        "hour" | "hourOf" => utility::hour(base, context),
        "minute" | "minuteOf" => utility::minute(base, context),
        "second" | "secondOf" => utility::second(base, context),
        "millisecond" | "millisecondOf" => utility::millisecond(base, context),
        "timezone" => utility::timezone(base, context),
        "timezoneOffsetOf" => utility::timezone_offset_of(base, context),
        "dateOf" => utility::date_of(base, context),
        "timeOf" => utility::time_of(base, context),
